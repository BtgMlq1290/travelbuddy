...
#--------------------------------------------------------------------------------------------------------
#This is the TravelManager which is a custom manager
...
#-----------------------------------------
#Send warning message if Destination field is less than 1 character
